...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; Project minor mode leader key accessible in `emacs state' and
   ;; `insert state'.
   ;; (default "S-C-M-m" for terminal mode, "<S-M-return>" for GUI mode).
   ;; Thus M-RET should work as leader key in both GUI and terminal modes.
   ;; S-C-M-m also should work in terminal mode, but not in GUI mode.
   dotspacemacs-project-minor-mode-emacs-leader-key (if window-system "<S-M-return>"
                                            "S-C-M-m")
